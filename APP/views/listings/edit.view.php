...
<section class="flex justify-center items-center mt-20">
    <div class="bg-white p-8 rounded-lg shadow-md w-full md:w-600 mx-6">
        <h2 class="text-4xl text-center font-bold mb-4">编辑职位</h2>
        ...
        <input type="hidden" name="_method" value="PUT">
            ...
            <div class="mb-4">
                <textarea name="description" placeholder="职位描述"
                    class="w-full px-4 py-2 border rounded focus:outline-none"
                    value="<?= $listing->description ?? '' ?>"></textarea>
            </div>
            <div class="mb-4">
                <input type="text" name="salary" placeholder="年薪"
                    class="w-full px-4 py-2 border rounded focus:outline-none"
                    value="<?= $listing->salary ?? '' ?>" />
            </div>
            <div class="mb-4">
                <input type="text" name="requirements" placeholder="要求"
                    class="w-full px-4 py-2 border rounded focus:outline-none"
                    value="<?= $listing->requirements ?? '' ?>" />
            </div>
            <div class="mb-4">
                <input type="text" name="benefits" placeholder="福利"
                    class="w-full px-4 py-2 border rounded focus:outline-none"
            ...
            <div class="mb-4">
                <input type="email" name="email" placeholder="接受申请的电子邮箱地址"
                    class="w-full px-4 py-2 border rounded focus:outline-none"
                    value="<?= $listing->email ?? '' ?>" />
            </div>
